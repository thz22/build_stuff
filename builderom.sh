...
# Local manifests
git clone https://github.com/thz22/local_manifest_odessa.git -b pixel .repo/local_manifests
echo ============================
...
# Clone O3
git clone https://github.com/thz22/build_soong.git -b fourteen build/soong
